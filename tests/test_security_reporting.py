...
from auth.security import DEFAULT_ADMIN_HASH, UserSession, get_admin_password, hash_password, verify_password
...
class TestSecurityAndReporting:
    def test_argon2_auth(self) -> None:
        ...
        assert verify_password(DEFAULT_ADMIN_HASH, effective_pass)
